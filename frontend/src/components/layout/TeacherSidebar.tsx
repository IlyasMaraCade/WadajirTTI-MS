...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Classes & Students', path: '/teacher/classes', icon: Users },
      { label: 'Attendance', path: '/teacher/attendance', icon: ClipboardList },
      { label: 'Exams & Marks', path: '/teacher/marks', icon: FileCheck },
...
const TeacherSidebar: React.FC<SidebarProps> = ({ collapsed, setMobileOpen }) => {
