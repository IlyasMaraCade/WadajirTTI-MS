    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          icon={School}
          gradient="bg-teal-50 border border-teal-100"
        ...
        <StatCard
          ...
          icon={BookOpen}
          gradient="bg-indigo-50 border border-indigo-100"
        ...
        <StatCard
          ...
          icon={CalendarClock}
          gradient="bg-amber-50 border border-amber-100"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="modern-card p-5 rounded-2xl">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-sm font-bold text-slate-900 tracking-tight">Active Course Assignments</h2>
          </div>
        ...
        <div className="modern-card p-5 rounded-2xl">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-sm font-bold text-slate-900 tracking-tight">Upcoming Subject Assessments</h2>
          </div>
