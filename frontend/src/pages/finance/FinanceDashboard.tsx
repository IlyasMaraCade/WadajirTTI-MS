...
export const FinanceDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Top Banner Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-slate-900 via-emerald-950/80 to-slate-900 p-5 sm:p-6 rounded-2xl text-white shadow-xl shadow-slate-900/10 border border-emerald-500/10">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-emerald-300 text-[10px] font-semibold backdrop-blur-md mb-2">
            <Sparkles className="w-3 h-3" />
            <span>Treasury, Billing & Institutional Accounting</span>
          </div>
          <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight">Finance Dashboard</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-white/10 text-white rounded-xl text-xs font-bold hover:bg-white/20 border border-white/10 backdrop-blur-md transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-emerald-500 text-slate-950 rounded-xl text-xs font-bold hover:bg-emerald-400 shadow-lg shadow-emerald-500/20 transition-all"
          >
